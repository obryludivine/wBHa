...
### MAF as an informative covariate

#### FDR

##### Reference Scenario (Scenario 1)
```{r Ind_maf_FDR_reference, fig.align='center', fig.width=8, fig.height=8}
graph_FDR_ind_maf$reference
```

##### Inverse Scenario (Scenario 2)
```{r Ind_maf_FDR_inverse, fig.align='center', fig.width=8, fig.height=8}
graph_FDR_ind_maf$inverse
```

##### Constant Scenario (Scenario 3)
```{r Ind_maf_FDR_constant, fig.align='center', fig.width=8, fig.height=8}
...
##### Reference Scenario (Scenario 1)
```{r Ind_maf_power_reference, fig.align='center', fig.width=8, fig.height=8}
graph_power_ind_maf$reference
```

##### Inverse Scenario (Scenario 2)
```{r Ind_maf_power_inverse, fig.align='center', fig.width=8, fig.height=8}
graph_power_ind_maf$inverse
```

##### Constant Scenario (Scenario 3)
```{r Ind_maf_power_constant, fig.align='center', fig.width=8, fig.height=8}
graph_power_ind_maf$constant
```

#### Power in the subgroup of rare variants

##### Reference Scenario (Scenario 1)
```{r Ind_maf_power_rare_reference, fig.align='center', fig.width=8, fig.height=8}
graph_power_rare_ind_maf$reference
```

##### Inverse Scenario (Scenario 2)
```{r Ind_maf_power_rare_inverse, fig.align='center', fig.width=8, fig.height=8}
graph_power_rare_ind_maf$inverse
```

##### Constant Scenario (Scenario 3)
```{r Ind_maf_power_rare_constant, fig.align='center', fig.width=8, fig.height=8}
graph_power_rare_ind_maf$constant
```

### 1/MAF as an informative covariate

#### FDR

##### Reference Scenario (Scenario 1)
```{r Ind_1bymaf_FDR_reference, fig.align='center', fig.width=8, fig.height=8}
graph_FDR_ind_1bymaf$reference
```

##### Inverse Scenario (Scenario 2)
```{r Ind_1bymaf_FDR_inverse, fig.align='center', fig.width=8, fig.height=8}
graph_FDR_ind_1bymaf$inverse
```

##### Constant Scenario (Scenario 3)
```{r Ind_1bymaf_FDR_constant, fig.align='center', fig.width=8, fig.height=8}
...
##### Reference Scenario (Scenario 1)
```{r Ind_1bymaf_power_reference, fig.align='center', fig.width=8, fig.height=8}
graph_power_ind_1bymaf$reference
```

##### Inverse Scenario (Scenario 2)
```{r Ind_1bymaf_power_inverse, fig.align='center', fig.width=8, fig.height=8}
graph_power_ind_1bymaf$inverse
```

##### Constant Scenario (Scenario 3)
```{r Ind_1bymaf_power_constant, fig.align='center', fig.width=8, fig.height=8}
graph_power_ind_1bymaf$constant
```

#### Power in the subgroup of common variants

##### Reference Scenario (Scenario 1)
```{r Ind_1bymaf_power_common_reference, fig.align='center', fig.width=8, fig.height=8}
graph_power_common_ind_1bymaf$reference
```

##### Inverse Scenario (Scenario 2)
```{r Ind_1bymaf_power_common_inverse, fig.align='center', fig.width=8, fig.height=8}
graph_power_common_ind_1bymaf$inverse
```

##### Constant Scenario (Scenario 3)
```{r Ind_1bymaf_power_common_constant, fig.align='center', fig.width=8, fig.height=8}
graph_power_common_ind_1bymaf$constant
```

### With an uninformative covariate from a uniform distribution U[0.05,0.05]

#### FDR

##### Reference Scenario (Scenario 1)
```{r Ind_uninfo_FDR_reference, fig.align='center', fig.width=8, fig.height=8}
graph_FDR_ind_uninfo$reference
```

##### Inverse Scenario (Scenario 2)
```{r Ind_uninfo_FDR_inverse, fig.align='center', fig.width=8, fig.height=8}
graph_FDR_ind_uninfo$inverse
```

##### Constant Scenario (Scenario 3)
```{r Ind_uninfo_FDR_constant, fig.align='center', fig.width=8, fig.height=8}
graph_FDR_ind_uninfo$constant
```

#### Power (difference between uninformative covariate and BH procedure)

##### Reference Scenario (Scenario 1)
```{r Ind_uninfo_power_reference, fig.align='center', fig.width=8, fig.height=8}
graph_power_ind_diff_uninfo_BH$reference
```

##### Inverse Scenario (Scenario 2)
```{r Ind_uninfo_power_inverse, fig.align='center', fig.width=8, fig.height=8}
graph_power_ind_diff_uninfo_BH$inverse
```

##### Constant Scenario (Scenario 3)
```{r Ind_uninfo_power_constant, fig.align='center', fig.width=8, fig.height=8}
graph_power_ind_diff_uninfo_BH$constant
```

### With large m values and m 1 values

#### FDR

##### Reference Scenario (Scenario 1)
```{r Ind_largem_fdr_reference, fig.align='center', fig.width=8, fig.height=4}
graph_FDR_ind_large_m$reference
```

##### Inverse Scenario (Scenario 2)
```{r Ind_largem_fdr_inverse, fig.align='center', fig.width=8, fig.height=4}
graph_FDR_ind_large_m$inverse
```
##### Constant Scenario (Scenario 3)
```{r Ind_largem_fdr_constant, fig.align='center', fig.width=8, fig.height=4}
...
##### Reference Scenario (Scenario 1)
```{r Ind_largem_power_reference, fig.align='center', fig.width=8, fig.height=4}
graph_power_ind_large_m$reference
```

##### Inverse Scenario (Scenario 2)
```{r Ind_largem_power_inverse, fig.align='center', fig.width=8, fig.height=4}
graph_power_ind_large_m$inverse
```

##### Constant Scenario (Scenario 3)
```{r Ind_largem_power_constant, fig.align='center', fig.width=8, fig.height=4}
...
##### Reference Scenario (Scenario 1)
```{r Ind_largem_power_rare_reference, fig.align='center', fig.width=8, fig.height=4}
graph_power_rare_ind_large_m$reference
```

##### Inverse Scenario (Scenario 2)
```{r Ind_largem_power_rare_inverse, fig.align='center', fig.width=8, fig.height=4}
graph_power_rare_ind_large_m$inverse
```

##### Constant Scenario (Scenario 3)
```{r Ind_largem_power_rare_constant, fig.align='center', fig.width=8, fig.height=4}
graph_power_rare_ind_large_m$constant
```

## Correlation Case with MAF as an informative covariate
...
#### Reference Scenario (Scenario 1)
```{r Corr_reference_power_rare, fig.align='center', fig.width=8, fig.height=8}
graph_power_rare_corr$reference
```

#### Inverse Scenario (Scenario 2)
```{r Corr_inverse_power_rare, fig.align='center', fig.width=8, fig.height=8}
graph_power_rare_corr$inverse
```

#### Constant Scenario (Scenario 3)
```{r Corr_constant_power_rare, fig.align='center', fig.width=8, fig.height=8}
...
#### Reference scenario (scenario 1)
```{r Semisimu_fdr_reference, fig.align='center', fig.width=8, fig.height=2}
graph_FDR_semisimu$Ref
```

#### Inverse scenario (scenario 2)
```{r Semisimu_fdr_Inverse, fig.align='center', fig.width=8, fig.height=2}
graph_FDR_semisimu$Inv
```

#### Constant scenario (scenario 2)
```{r Semisimu_fdr_constant, fig.align='center', fig.width=8, fig.height=2}
...
#### Reference scenario (scenario 1)
```{r Semisimu_power_reference, fig.align='center', fig.width=8, fig.height=2}
graph_power_semisimu$Ref
```

#### Inverse scenario (scenario 2)
```{r Semisimu_power_Inverse, fig.align='center', fig.width=8, fig.height=2}
graph_power_semisimu$Inv
```

#### Constant scenario (scenario 2)
```{r Semisimu_power_constant, fig.align='center', fig.width=8, fig.height=2}
...
#### Reference scenario (scenario 1)
```{r Semisimu_power_rare_reference, fig.align='center', fig.width=8, fig.height=2}
graph_power_rare_semisimu$Ref
```

#### Inverse scenario (scenario 2)
```{r Semisimu_power_rare_Inverse, fig.align='center', fig.width=8, fig.height=2}
graph_power_rare_semisimu$Inv
```

#### Constant scenario (scenario 2)
```{r Semisimu_power_rare_constant, fig.align='center', fig.width=8, fig.height=2}
